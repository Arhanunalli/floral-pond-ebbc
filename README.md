...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/floral-pond-ebbc)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/floral-pond-ebbc
```

A live public deployment of this template is available at [https://floral-pond-ebbc.templates.workers.dev](https://floral-pond-ebbc.templates.workers.dev)
